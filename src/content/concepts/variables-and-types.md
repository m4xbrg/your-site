...
lessons: []
learningGoals:
  - Recognize when and why to introduce variables in a program
  - Distinguish between common primitive data types
  - Choose appropriate types when modeling simple values
relatedConcepts: []
---
Variables let you associate a name with a value. Most languages give you a few primitive types (numbers, strings, booleans) and
composite types (arrays/lists, objects/maps).
