...
declare module 'astro:content' {
	...
	type ContentEntryMap = {
		"concepts": {
"computer-science/control-flow.md": {
	id: "computer-science/control-flow.md";
  slug: "computer-science/control-flow";
  body: string;
  collection: "concepts";
  data: any
} & { render(): Render[".md"] };
"computer-science/data-structures.md": {
	id: "computer-science/data-structures.md";
...
"mathematics/derivatives.md": {
	id: "mathematics/derivatives.md";
  slug: "mathematics/derivatives";
  body: string;
  collection: "concepts";
  data: any
} & { render(): Render[".md"] };
"mathematics/integrals.md": {
	id: "mathematics/integrals.md";
  slug: "mathematics/integrals";
  body: string;
  collection: "concepts";
  data: any
} & { render(): Render[".md"] };
